const About = () => {
  return (
    <section
      id="about"
      className="scroll-mt-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28"
    >
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-inherit">
        About Me
      </h2>

      <p className="text-inherit leading-7 sm:leading-8 text-sm sm:text-base md:text-lg max-w-3xl">
